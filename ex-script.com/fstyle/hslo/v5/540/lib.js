...
!(function(i) {
  ...
  function t(t, o) {
    var s,
      ...
      e,
      r,
      l = i('<div class="minicolors" />'),
      h = i.minicolors.defaults;
    if (!t.data("minicolors-initialized")) {
      if (
        ((o = i.extend(!0, {}, h, o)),
        l
          .addClass("minicolors-theme-" + o.theme)
          .toggleClass("minicolors-with-opacity", o.opacity),
        void 0 !== o.position &&
        ...
        for (
          e.addClass("minicolors-with-swatches"),
            a = i('<ul class="minicolors-swatches"></ul>').appendTo(e),
            r = 0;
          r < o.swatches.length;
          ++r
        )
          (n = o.swatches[r]),
            ...
            i(
              ...
              .appendTo(a)
              .data("swatch-color", o.swatches[r])
              .find(".minicolors-swatch-color")
              .css({ backgroundColor: C(n), opacity: n.a }),
            (o.swatches[r] = n);
  ...
  function n(i, t, o) {
    ...
    t.originalEvent.changedTouches &&
      ...
      i.parent().is(".minicolors-slider-wheel") &&
        ...
        r < 0 && (r += 2 * Math.PI),
        n > 75 &&
          ((n = 75), (u = 75 - 75 * Math.cos(r)), (g = 75 - 75 * Math.sin(r))),
        (u = Math.round(u)),
        (g = Math.round(g))),
      i.is(".minicolors-grid")
        ...
        : h
            .stop(!0)
            .animate({ top: g + "px" }, m, l.animationEasing, function() {
              e(c, i);
            });
  }
  function e(i, t) {
    ...
    if (
      ...
      (u = m.opacity ? parseFloat(1 - z.y / y.height()).toFixed(2) : 1),
        r(i, p, u);
  ...
  function c(t, o) {
    ...
    switch (
      ...
      I.opacity &&
        ...
        q.css("top", d + "px")),
      "transparent" === t.val().toLowerCase() &&
        S.find("span").css("opacity", 0),
      ...
      case "saturation":
        (h = f((5 * a.h) / 12, 0, 150)),
          (d = f(
            z.height() - Math.ceil(a.b / (100 / z.height())),
            0,
            z.height()
          )),
          D.css({ top: d + "px", left: h + "px" }),
      ...
      case "brightness":
        (h = f((5 * a.h) / 12, 0, 150)),
          (d = f(
            z.height() - Math.ceil(a.s / (100 / z.height())),
            0,
            z.height()
          )),
          D.css({ top: d + "px", left: h + "px" }),
  ...
  function g(i, t) {
    ...
    return (
      ...
      s[3] && (s[3] = f(parseFloat(s[3], 10), 0, 1)),
      t
        ? s[3]
            ...
            return void 0 === e
              ...
              : (i(this).each(function() {
                  "object" == typeof e && "null" !== e
                    ? (e.opacity &&
                        i(this).attr("data-opacity", f(e.opacity, 0, 1)),
    ...
    i([document, top.document])
      ...
      .on(
        ...
        function(t) {
          var o = i(this);
          t.preventDefault(),
            i(t.delegateTarget).data("minicolors-target", o),
            n(o, t, !0);
        }
      )
...
})(
  {
        ...
        (function(r) {
          function i(t) {
            return this instanceof i
              ? (n.call(this, t),
                (this.options = t || {}),
                (this.binding = this.options.useJS ? u : h),
                (this.buffer = null),
                (this.pos = 0),
          ...
          s(i, n),
            (i.prototype._transform = function(t, e, i) {
              ...
              (this.buffer = this.buffer
                ? r.concat([this.buffer, t], this.buffer.length + t.length)
                : t),
                this._main(i);
            }),
            ...
            (i.prototype.read_MagicNumber = function() {
              ...
              return (4294967280 & e) === o.MAGICNUMBER_SKIPPABLE
                ? void (this.state = f.SKIP_SIZE)
                : e !== o.MAGICNUMBER
                ? ((this.pos = t),
                  this.emit_Error(
                  ...
                  !0)
                : void (this.state = f.DESCRIPTOR);
            }),
            (i.prototype.read_SkippableSize = function() {
              var t = this.pos;
              return this.check_Size(c.SKIP_SIZE)
                ? !0
                : ((this.state = f.SKIP_DATA),
                  void (this.skippableSize = a.readInt32LE(this.buffer, t)));
            }),
            (i.prototype.read_Descriptor = function() {
              ...
              if (r !== o.VERSION)
                return (
                  (this.pos = t),
                  this.emit_Error("Invalid version: " + r + " != " + o.VERSION),
                  !0
                );
              if ((e >> 1) & 1)
              ...
              return null === n
                ? ((this.pos = t),
                  this.emit_Error("Invalid block max size: " + i),
                  !0)
                : ((this.descriptor = {
            ...
            (i.prototype.read_DescriptorChecksum = function() {
              ...
              return r !== e
                ? ((this.pos = t),
                  ...
                  !0)
                : void (this.state = f.DATABLOCK_SIZE);
            }),
            ...
            (i.prototype.read_EOS = function() {
              if (this.descriptor.streamChecksum) {
                ...
                var e = a.readInt32LE(this.buffer, t);
                if (e !== a.streamChecksum(null, this.currentStreamChecksum))
                  return (
                    (this.pos = t),
                    this.emit_Error(
            ...
            (i.prototype._main = function(t) {
              for (var e, r = this.pos; !e && this.pos < this.buffer.length; )
                this.state === f.MAGIC && (e = this.read_MagicNumber()),
                  this.state === f.SKIP_SIZE && (e = this.read_SkippableSize()),
                  this.state === f.DESCRIPTOR && (e = this.read_Descriptor()),
                  this.state === f.SIZE && (e = this.read_Size()),
                  this.state === f.DICTID && (e = this.read_DictId()),
                  this.state === f.DESCRIPTOR_CHECKSUM &&
                    (e = this.read_DescriptorChecksum()),
                  this.state === f.DATABLOCK_SIZE &&
                    (e = this.read_DataBlockSize()),
                  this.state === f.DATABLOCK_DATA &&
                    (e = this.read_DataBlockData()),
                  this.state === f.DATABLOCK_CHECKSUM &&
                    (e = this.read_DataBlockChecksum()),
                  this.state === f.DATABLOCK_UNCOMPRESS &&
                    (e = this.uncompress_DataBlock()),
                  this.state === f.EOS && (e = this.read_EOS());
              this.pos > r &&
      ...
      function(t, e, r) {
        (function(r) {
          function i(t) {
            ...
            (this.descriptor = { flg: r, bd: (7 & s) << 4 }),
              (this.buffer = []),
              (this.length = 0),
              (this.first = !0),
              (this.checksum = null);
          ...
          s(i, n),
            (i.prototype.headerSize = function() {
            ...
            (i.prototype.header = function() {
              var t = this.headerSize(),
                e = new r(t);
              (this.state = f.MAGIC),
                e.writeInt32LE(o.MAGICNUMBER, 0, !0),
                (this.state = f.DESCRIPTOR);
              var i = e.slice(c.MAGIC, e.length - 1);
              i.writeUInt8(this.descriptor.flg, 0, !0),
                i.writeUInt8(this.descriptor.bd, 1, !0);
              var n = 2;
              return (
                (this.state = f.SIZE),
                this.options.streamSize &&
                  (i.writeInt32LE(0, n, !0),
                  i.writeInt32LE(this.size, n + 4, !0),
                  (n += c.SIZE)),
                (this.state = f.DICTID),
                this.options.dict &&
                  (i.writeInt32LE(this.dictId, n, !0), (n += c.DICTID)),
                (this.state = f.DESCRIPTOR_CHECKSUM),
                e.writeUInt8(a.descriptorChecksum(i), c.MAGIC + n, !1),
                e
              );
            }),
            (i.prototype.update_Checksum = function(t) {
              (this.state = f.CHECKSUM_UPDATE),
            ...
            (i.prototype.compress_DataBlock = function(t) {
              ...
              if (
                ...
                o > 0 && o <= this.options.blockMaxSize
                  ? (n.writeUInt32LE(o, 0, !0),
                    (n = n.slice(0, c.DATABLOCK_SIZE + o + e)))
                  : (n.writeInt32LE(2147483648 | t.length, 0, !0),
                    (n = n.slice(0, c.DATABLOCK_SIZE + t.length + e)),
                    t.copy(n, c.DATABLOCK_SIZE)),
                (this.state = f.DATABLOCK_CHECKSUM),
            ...
            (i.prototype._transform = function(t, e, i) {
              ...
              for (
                var s = r.concat(this.buffer, this.length), o = 0, a = s.length;
                a >= n;
                a -= n, o += n
              )
                this.push(this.compress_DataBlock(s.slice(o, o + n)));
              a > 0
                ? ((this.buffer = [s.slice(o)]),
      ...
      function(t, e, r) {
        (function(e) {
          (r.MAGICNUMBER = 407708164),
            (r.MAGICNUMBER_BUFFER = new e(4)),
            r.MAGICNUMBER_BUFFER.writeUInt32LE(r.MAGICNUMBER, 0, !1),
            (r.EOS = 0),
            (r.EOS_BUFFER = new e(4)),
            r.EOS_BUFFER.writeUInt32LE(r.EOS, 0, !1),
            (r.VERSION = 1),
        ...
        !(function(t) {
          ...
          (r.prototype.fromBits = i),
            ...
            (r.prototype.toString = function(t) {
              ...
              for (
                var i = this.clone(), n = new Array(32), s = 31;
                s >= 0 &&
                (i.div(e),
                (n[s] = i.remainder.toNumber().toString(t)),
                i.gt(e));
                s--
              );
        ...
        !(function(t) {
          ...
          function s(t, e) {
            (e = e || 10),
              ...
              (this._a48 = 0);
            for (
              var i = o[e] || new r(Math.pow(e, 5)), n = 0, s = t.length;
              s > n;
              n += 5
            ) {
          ...
          (r.prototype.fromBits = i),
            ...
            (r.prototype.toString = function(t) {
              ...
              if (!this.gt(e)) return this.toNumber().toString(t);
              for (
                var i = this.clone(), n = new Array(64), s = 63;
                s >= 0 &&
                (i.div(e),
                (n[s] = i.remainder.toNumber().toString(t)),
                i.gt(e));
          ...
          !(function(i) {
            ...
            function s() {
              return 2 == arguments.length
                ? new s(arguments[1]).update(arguments[0]).digest()
                : this instanceof s
                ? void o.call(this, arguments[0])
                : new s(arguments[0]);
            }
            function o(t) {
              return (
                (this.seed = t instanceof a ? t.clone() : a(t)),
                (this.v1 = this.seed.clone().add(p)),
                (this.v2 = this.seed.clone().add(u)),
                (this.v3 = this.seed.clone()),
                (this.v4 = this.seed.clone().subtract(h)),
                (this.total_len = 0),
                (this.memsize = 0),
                (this.memory = null),
                this
            ...
            (s.prototype.init = o),
              (s.prototype.update = function(t) {
                ...
                if (this.memsize > 0) {
                  ...
                  i
                    ? (this.v1.xxh_update(
                        (this.memory.charCodeAt(h + 1) << 8) |
                          this.memory.charCodeAt(h),
                        (this.memory.charCodeAt(h + 3) << 8) |
                          this.memory.charCodeAt(h + 2)
                      ),
                      (h += 4),
                      this.v2.xxh_update(
                        (this.memory.charCodeAt(h + 1) << 8) |
                    ...
                    : (this.v1.xxh_update(
                        (this.memory[h + 1] << 8) | this.memory[h],
                        (this.memory[h + 3] << 8) | this.memory[h + 2]
                      ),
                      (h += 4),
                      this.v2.xxh_update(
                        (this.memory[h + 1] << 8) | this.memory[h],
                ...
                return (
                  a > s &&
                    (i
                      ...
                      : e
                      ? this.memory.set(t.subarray(s, a), this.memsize)
                      : t.copy(this.memory, this.memsize, s, a),
                    (this.memsize = a - s)),
                  this
                );
              }),
                ...
                for (
                  t =
                    this.total_len >= 16
                      ...
                      : this.seed.add(l),
                    t.add(o.fromNumber(this.total_len));
                  s - 4 >= n;

                )
                  i
                    ? o.fromBits(
                        (r.charCodeAt(n + 1) << 8) | r.charCodeAt(n),
                        (r.charCodeAt(n + 3) << 8) | r.charCodeAt(n + 2)
                      )
                    : o.fromBits(
                        (r[n + 1] << 8) | r[n],
                        (r[n + 3] << 8) | r[n + 2]
                    ...
                    (n += 4);
                for (; s > n; )
                  o.fromBits(i ? r.charCodeAt(n++) : r[n++], 0),
                    t
                      .add(o.multiply(l))
                      .rotl(11)
                      .multiply(h);
      ...
      function(t, e, r) {
        ...
        !(function(t) {
          ...
          function r(t) {
            ...
            var f = t.length;
            (h = "=" === t.charAt(f - 2) ? 2 : "=" === t.charAt(f - 1) ? 1 : 0),
        ...
        (function(r) {
          ...
          function d(t, e) {
            for (
              ...
              (x("maybeReadMore read 0"), t.read(0), r !== e.length);
          ...
          function _(t) {
            return function() {
              var e = t._readableState;
              x("pipeOnDrain", e.awaitDrain),
                e.awaitDrain && e.awaitDrain--,
                0 === e.awaitDrain && k(t, "data") && ((e.flowing = !0), y(t));
            };
          }
          function g(t) {
          ...
          function v(t, e) {
            e.reading || (x("resume read 0"), t.read(0)),
              (e.resumeScheduled = !1),
              t.emit("resume"),
              y(t),
          ...
          function b(t, e) {
            ...
            if (0 === n) r = null;
              ...
              (r = s ? i.join("") : 1 === i.length ? i[0] : B.concat(i, n)),
                (i.length = 0);
              ...
              for (var h = 0, u = 0, f = i.length; f > u && t > h; u++) {
                ...
                s ? (r += a.slice(0, c)) : a.copy(r, h, 0, c),
                  c < a.length ? (i[0] = a.slice(c)) : i.shift(),
                  (h += c);
              }
            }
            return r;
          ...
          (n.prototype.read = function(t) {
            ...
            if (
              ...
              return (
                x("read: emitReadable", e.length, e.ended),
                0 === e.length && e.ended ? w(this) : c(this),
                null
              );
            ...
            x("need readable", i),
              (0 === e.length || e.length - t < e.highWaterMark) &&
                ((i = !0), x("length less than watermark", i)),
              (e.ended || e.reading) && ((i = !1), x("reading or ended", i)),
              i &&
                (x("do read"),
                (e.reading = !0),
                (e.sync = !0),
            ...
            (n.prototype.pipe = function(t, e) {
              ...
              return (
                ...
                t.once("finish", u),
                t.emit("pipe", c),
                l.flowing || (x("pipe resume"), c.resume()),
                t
              );
            }),
            ...
            (n.prototype.on = function(t, e) {
              ...
              if (
                ...
                i.readableListening ||
                  ...
                  (i.emittedReadable = !1),
                  (i.needReadable = !0),
                  i.reading ? i.length && c(this, i) : C(g, this));
              }
              return r;
            }),
            ...
            (n.prototype.resume = function() {
              ...
              return (
                t.flowing || (x("resume"), (t.flowing = !0), m(this, t)), this
              );
            }),
            ...
            (n.prototype.wrap = function(t) {
              ...
              t.on("end", function() {
                ...
                t.on("data", function(n) {
                  if (
                    (x("wrapped data"),
                    e.decoder && (n = e.decoder.write(n)),
                    (!e.objectMode || (null !== n && void 0 !== n)) &&
                      (e.objectMode || (n && n.length)))
                  ) {
                    var s = i.push(n);
                    s || ((r = !0), t.pause());
                  }
    ...
    25: [
      function(t, e, r) {
        ...
        function o(e) {
          ...
          return this instanceof o || this instanceof r
        ...
        function f(t, e, r, i, s) {
          ...
          if ((a || (e.needDrain = !0), e.writing || e.corked)) {
            ...
            (e.lastBufferedRequest = new n(r, i, s)),
              h
        ...
        function c(t, e, r, i, n, s, o) {
          (e.writelen = i),
            ...
            (e.writing = !0),
            (e.sync = !0),
            r ? t._writev(n, e.onwrite) : t._write(n, s, e.onwrite),
            (e.sync = !1);
        }
        ...
        function m(t, e) {
          ...
          if (t._writev && r && r.next) {
            for (var i = [], n = []; r; )
              n.push(r.callback), i.push(r), (r = r.next);
            e.pendingcb++,
              (e.lastBufferedRequest = null),
              c(t, e, !0, e.length, i, "", function(t) {
        ...
        A.inherits(o, C),
          ...
          (o.prototype.write = function(t, e, r) {
            ...
            return (
              ...
              S.isBuffer(t) ? (e = "buffer") : e || (e = n.defaultEncoding),
              "function" != typeof r && (r = i),
              n.ended
                ? a(this, r)
                : h(this, n, t, r) &&
                  (n.pendingcb++, (s = f(this, n, t, e, r))),
              s
            );
          }),
          ...
          (o.prototype.end = function(t, e, r) {
            ...
            "function" == typeof t
              ...
              i.ending || i.finished || w(this, i, r);
          });
      },
      {
        "./_stream_duplex": 21,
    ...
    27: [
      function(t, e, r) {
        (function(t) {
          "use strict";
          function r(e) {
            for (var r = new Array(arguments.length - 1), i = 0; i < r.length; )
              r[i++] = arguments[i];
            t.nextTick(function() {
              e.apply(null, r);
            });
        ...
        (function(e, i) {
          function n(t, e) {
            ...
            return (
              ...
              _(e) ? (i.showHidden = e) : e && r._extend(i, e),
          ...
          function s(t, e) {
            var r = n.styles[e];
            return r
              ? "[" + n.colors[r][0] + "m" + t + "[" + n.colors[r][1] + "m"
              : t;
          }
          function o(t, e) {
            return t;
          ...
          function h(t, e, i) {
            ...
            if (
              (E(e) && (m = " " + RegExp.prototype.toString.call(e)),
              A(e) && (m = " " + Date.prototype.toUTCString.call(e)),
              C(e) && (m = " " + f(e)),
              0 === o.length && (!v || 0 == e.length))
            )
              return b[0] + m + b[1];
            if (0 > i)
              return E(e)
            ...
            if (
              ...
              a ||
                (t.seen.indexOf(u.value) < 0
                  ? ((a = g(r) ? h(t, u.value, null) : h(t, u.value, r - 1)),
                    a.indexOf("\n") > -1 &&
                      (a = s
                        ? a
                            .split("\n")
          ...
          (r.format = function(t) {
            ...
            for (
              var r = 1,
                i = arguments,
                s = i.length,
                o = String(t).replace(M, function(t) {
                  if ("%%" === t) return "%";
                  if (r >= s) return t;
                  switch (t) {
                    case "%s":
      ...
      function(t, e, r) {
        (function(e) {
                ...
                switch (a) {
                  ...
                  case 3:
                    (h = t[n + 1]),
                      ...
                      128 === (192 & h) &&
                        128 === (192 & u) &&
                        ((c = ((15 & s) << 12) | ((63 & h) << 6) | (63 & u)),
                        c > 2047 && (55296 > c || c > 57343) && (o = c));
                    break;
                  case 4:
                    (h = t[n + 1]),
                      (u = t[n + 2]),
          ...
          function R(t) {
            ...
            for (var r = "", i = 0; e > i; )
              r += String.fromCharCode.apply(String, t.slice(i, (i += X)));
            return r;
          }
          function k(t, e, r) {
            var i = "";
          ...
          function z(t, e, r, i, n) {
            return (
              n || P(t, e, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
          ...
          function j(t, e, r, i, n) {
            return (
              n ||
                P(t, e, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
          ...
          (s.prototype.slice = function(t, e) {
            ...
            (s.prototype.writeUIntLE = function(t, e, r, i) {
              (t = +t),
                (e = 0 | e),
                (r = 0 | r),
                i || T(this, t, e, r, Math.pow(2, 8 * r), 0);
              var n = 1,
                s = 0;
    ...
    lz4: [
      function(t, e, r) {
        ...
        (e.exports.decodeBlock = i.uncompress),
          (e.exports.encodeBound = i.compressBound),
          (e.exports.encodeBlock = i.compress),
          (e.exports.encodeBlockHC = i.compressHC);
      },
      {
        "./decoder": 2,
        "./decoder_stream": 3,
